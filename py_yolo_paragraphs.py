...
def calculate_iou(box1, box2):
    ...
    Args:
        box1, box2 (list): Coordenadas de las cajas en formato [x1, y1, x2, y2].
    Returns:
        tuple: (IoU, área de intersección, área de box1, área de box2)
    """
...
def is_inside(box1, box2):
    """
    Comprueba si box1 está completamente dentro de box2.
    Args:
        box1, box2 (list): Coordenadas de las cajas en formato [x1, y1, x2, y2].
    Returns:
        bool: True si box1 está completamente dentro de box2.
    """
    x1, y1, x2, y2 = box1
    a1, b1, a2, b2 = box2
